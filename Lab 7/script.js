...
// Встановлюємо межі
const maxLeft = 0;   // Не далі початкової позиції вліво
const maxRight = 1400; // Не далі 300px вправо

document.getElementById('btn-left').addEventListener('click', () => {
    // Рухаємо вліво, тільки якщо поточна позиція більша за мінімальну
...
document.getElementById('btn-right').addEventListener('click', () => {
    // Рухаємо вправо, тільки якщо поточна позиція менша за максимальну
